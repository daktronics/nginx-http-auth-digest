...
typedef struct {
	...
	ngx_str_t user_agents_allow_basic;
	ngx_str_t use_basic;
...
static ngx_int_t ngx_http_auth_digest_check_credentials(ngx_http_request_t* r, ngx_http_auth_digest_cred_t* ctx);
...
static ngx_command_t ngx_http_auth_digest_commands[] =
{
	...
	{
		ngx_string("auth_digest_use_basic"),
		NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_HTTP_LMT_CONF | NGX_CONF_TAKE1,
		ngx_conf_set_str_slot,
		NGX_HTTP_LOC_CONF_OFFSET,
		offsetof(ngx_http_auth_digest_loc_conf_t, use_basic),
		NULL
	},
	{
		ngx_string("user_agents_allow_basic"),
		NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_CONF_TAKE1,
		ngx_conf_set_str_slot,
		NGX_HTTP_LOC_CONF_OFFSET,
		offsetof(ngx_http_auth_digest_loc_conf_t, user_agents_allow_basic),
		NULL
	},
